...
levels(corr_plots1$type) <- c("Perfect Correlation", "Strong Correlation", "Moderate Correlation", "No Correlation")
...
With a data frame of this size, we shouldn't be surprised that there are `r sum(is.na(df_mpg))` `NA` values present.  The next question is: where do these 
