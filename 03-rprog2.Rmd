...
4. Delete the sample content from the R Markdown file (line 8 and beyond).
...
2019. On Canvas, download the ozone data (.csv) and R Markdown template (.Rmd),
which includes a description of the data, the homework questions, and the
general framework of code-figure-text integration, including a code appendix.
...
file and detect the data file in the `data` subfolder, for example.
