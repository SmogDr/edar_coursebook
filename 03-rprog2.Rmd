...
### Day 1: Data import and working directories
...
general framework of code-text integration (e.g., code appendix). Save the data
and template files in your local R Project in the corresponding directories
