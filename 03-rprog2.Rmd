...
Download the R Markdown template from Canvas. 
...
Find the maximum and minimum values for the month (and compare them to the standard, even though it’s only a 1-hr measurement)
Count how many values are above 0.07 in the dataset
Mutate the sample_measurement column to convert “parts-per-million” into “parts-per-billion” units (i.e., multiply by 1000)
