...
session as its own object, which means you don't need to use quotes---most
of the time.
```
...
```{r markdown-2, echo=FALSE, cache=FALSE, fig.align='center', fig.cap="Example R Markdown when rendered into an html document.", out.width=700}
