...
its advantages. For example, let's look at the data from Figure \@ref(fig:temp-plot) as two boxplots.

``` {r temp-boxplot, echo=FALSE, out.width="700pt", fig.align="center", fig.cap="Boxplots of hourly temperatures in Colorado and Hawaii for July, 2010. Whiskers represent 1.5*IQR."}
...
```{r noaa-hi-week-plot, warning=FALSE, message=FALSE}
