...
cloud (i.e., "Think Dropbox but much, much better"). 
...
GitHub (properly), you will receive an "incomplete" on the assignment.

1. Please download and install the latest version of R and RStudio appropriate for your computer's operating system. 
...
3. Make a private repository on GitHub. 
