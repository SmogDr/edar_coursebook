...
We will primarily follow Jenny Bryan's advice from [Happy Git with R](https://happygitwithr.com/) and her related [paper](https://www.tandfonline.com/doi/full/10.1080/00031305.2017.1399928) for
R/RStudio and Git/GitHub installation and connection, sprinkled with
suggestions from others. Git is a version control system (i.e., "Think Word
track changes on steroids"). GitHub is the most common git-based collaborative
cloud (i.e., "Think Dropbox but much, much better"). Everything in this class
will be done within an RStudio Project on your local computer that is mirrored
on a private GitHub repository. If you do not use GitHub (properly), you will
receive an "incomplete" on the given assignment.

1. Install R and RStudio appropriate your machine's operating system.

- Pre-compiled binary of [R](https://cran.r-project.org)
- Preview version of [RStudio](https://rstudio.com/products/rstudio/download/#download) 
...
- Install [Git](https://git-scm.com/downloads); see [here](https://happygitwithr.com/install-git.html) for OS-specific installation instructions
...
- Consider downloading a [GUI Git Client](https://happygitwithr.com/git-client.html) to make version control easier and more intuitive. [GitHub Desktop](https://desktop.github.com/) is likely sufficient for this course, but it is up to you.
...
- Bonus: Sign up for free student perks via [GitHub Education](https://education.github.com/).

3. Connect Git, GitHub, and RStudio.

- Read and follow the [instructions](https://happygitwithr.com/connect-intro.html) in Chapters 9-13 *exactly.* I hope you won't need to look at Chapter 14! Move slowly and carefully.

4. Make a private [repository](https://happygitwithr.com/push-pull-github.html#make-a-repo-on-github), or "repo", on GitHub. 

- Log on GitHub
- Click green "New repository" button
- Name the repository *MECH481A6*
- Select *private* and *Initialize this repository with a README*
- Copy the HTTPS clone URL via green "Clone or Download" button

4. Make a corresponding RStudio Project (.RProj) via `git clone`.

- In RStudio, create a new Project (File > New Project > Version Control > Git)
- In the *repository URL*, paste 
- Navigate to RStudio > Preferences, and *DO NOT* "Restore .RData into workspace at setup" and *NEVER* "save workspace to .RData on exit"
- 
