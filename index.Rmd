...
We will follow Jenny Bryan's advice from [Happy Git with R](https://happygitwithr.com/) to for R/RStudio and git/GitHub installation and
connection. Git is a version control system; GitHub is the most common
git-based collaborative cloud system. Everything in this class will be done
within an RStudio Project on your local computer that is mirrored on a private
GitHub repository. 
