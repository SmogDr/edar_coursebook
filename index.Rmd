...
---
```{r ch1_packages, echo = FALSE, warning = FALSE}
library(tidyverse)
library(bookdown)
library(knitr)
library(kableExtra)
...
[Happy Git with R](https://happygitwithr.com/) by Dr. Jenny Bryan is a helpful resource for installation and set-up.

If you want to generate PDF output from R Markdown, you will also need to install LaTex. More installation guidance can be found [here](https://bookdown.org/yihui/rmarkdown/installation.html). 

```{r tinytex, echo = FALSE}
# install R package
