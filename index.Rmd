...
- Install [Git](https://git-scm.com/downloads); see [here](https://happygitwithr.com/install-git.html) and [here](https://rstats.wtf/set-up-an-r-dev-environment.html) for OS-specific installation instructions (e.g., install *parts of* Xcode on Mac).
