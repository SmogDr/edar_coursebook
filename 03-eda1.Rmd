...
ggplot(NOAA_temps, aes(y = location, x = temp_hr_f)) +
  geom_jitter(aes(color = location),
              height = 0.15,
              size = 1.5,
              shape = 1) +
    labs(title ="Hourly Temperature Values for July, 2010",
       y = "Region", x = "Temperature, °F") +
  theme_bw()
...
``` {r cdf_ME_salaries, echo = FALSE}
  
  #alternate method if you don't want to calculate cumulative fractions
  ggplot(data = ordered_salaries, aes(x = salary)) +
  geom_step(stat = "ecdf") +
  theme_bw() +
