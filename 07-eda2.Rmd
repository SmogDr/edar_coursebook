...
Whith multivariate data we often consider far more than just 2 variables of interest; however, visualizing more than 2 variables can be challenging for a single plot. Fortunately, there are advanced statistical approaches to exploring such data (e.g., multivariate regression, principal components, machine learning, etc.),but these techniques are beyond the scope of this course. Instead, I will provide here a few graphical techniques that are useful for multivariate data exploration.  
