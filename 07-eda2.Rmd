...
Here is a better version of Figure \@ref(fig:colorplot-1) using colors that don't overlap with color blindness. 
...
g3 + scale_colour_manual(values = c("purple", "orange", "navy")) +
  theme_classic()
```
