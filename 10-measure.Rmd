...
```{r margin-of-error, echo=FALSE, fig.height=4, fig.width=4, fig.align="center", fig.cap="Relative gain in Precision when estimating a mean with repeated measures"}
data <- tibble(samples = seq(1,20,1),
               precision = 1/(sqrt(samples)))
plot(data$precision~data$samples, 
     xlab = "n repeated measurements",
     ylab = "Relative Gain in Precision")
```
...
weights %>%
  ...
  kbl(digits = 0,
      caption = "Example Weights and Precision, grams",
      align = "c") %>%
