...
object. For example, if you saved the string `"Volckens"` as the object
`my_name` (`my_name <- "Volckens"`), then in later code, if you type `my_name`
(no quotation marks), you'll get `"Volckens"`, while if you type out `"my_name"`
