...
```{r cran10000, echo = FALSE, out.width = "600pt", fig.align = "center", fig.cap = "Celebrating CRAN's 10,000th package, which was created by Dr. Brooke Anderson."}
...
```{r phone1, eval = FALSE, messages = FALSE, warnings = FALSE, results = FALSE}
...
```{r phone2, messages = FALSE, warnings = FALSE, results = FALSE}
...
```{r hp6, echo = FALSE, message = FALSE, results = TRUE}
...
```{r read_daily_true, echo = FALSE, message = FALSE}
library(package = "readr")
daily_show <- read_csv(file = "data/daily_show_guests.csv",
                       skip = 4)
```

```{r read_daily_echo, eval = FALSE}
library(package = "readr")
...
```{r hp9, message = FALSE, warning = FALSE}
