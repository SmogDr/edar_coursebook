...
```{r mpg_bar, warning = FALSE, message = FALSE, fig.cap = "Example of a simple call to `ggplot` showing counts of vehicle classes from the `mpg` dataframe."}
...
```{r mpg_fill, warning = FALSE, message = FALSE, fig.cap = "Example of a call to `ggplot` showing counts of vehicle classes from the `mpg` dataframe and colored by the `fill` aesthetic mapped to drive type (`drv`)."}
...
```{r mpg_comp, eval=FALSE, message = FALSE}
...
```{r mpg_green, warning = FALSE, message = FALSE, fig.cap = "Example of a call to `ggplot` showing counts of vehicle classes from the `mpg` dataframe and colored by the `fill` aesthetic mapped to drive type (`drv`)."}
...
```{r mpg_custom_plot, message = FALSE, warning = FALSE, fig.cap= "A two-layer (two `geom`) plot with customization"}
...
```{r ggplot_save, eval = FALSE, message = FALSE, warning = FALSE}
