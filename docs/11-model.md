...
<p class="caption">(\#fig:OLS-life)Average Life Expectancy vs. Educational Attainment for Men over 25 in Counties in 2009</p>
</div>
...
## F-statistic: 130.2 on 1 and 173 DF,  p-value: < 2.2e-16
```
...
<div class="rmdnote">
<p>R has a quick and easy way to explore model fits by calling
