...
These descriptive statistics allow some quick insight into the data:  
  ...
  - The max salary is the same for both sexes and is 10x higher than the median.  With a `min()` of 0 for both sexes, this implies some level of skewness in these data.  
