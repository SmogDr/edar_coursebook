...
- Create and extract quantitative information from a cumulative distribution plot
...
- Create and interpret data from a time-series plot
- Define autocorrelation (quantitatively and qualitatively) 
- Create and interpret features from autocorrelation and partial autocorrelation plots
