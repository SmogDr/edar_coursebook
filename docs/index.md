...
- Install [Git](https://git-scm.com/downloads); see [here](https://happygitwithr.com/install-git.html) and [here](https://rstats.wtf/set-up-an-r-dev-environment.html) for OS-specific installation instructions (e.g., need to install *parts of* Xcode for Mac OS).
...
- Keep in mind: You should save the local R Project from this step in a top-level directory. We suggest creating an `R` folder at the top of your `Documents` folder (or OS-specific equivalent) to contain all of your R Projects. For the duration of this course, you should just have a directory pathname like `/user/Documents/R/MECH481A6.Rproj`. We will discuss directory structures and pathnames more in the next chapter.
- Read and follow these [instructions](https://happygitwithr.com/new-github-first.html) *exactly* with the following additions: Name the repository *MECH481A6* and make it *private* within the class GitHub organization
- Within your MECH481A6.Rproj folder, add subfolders called `data`, `code`, and `figs` to practice a [project-oriented workflow](https://uncoast-unconf.github.io/uu-2019-day-zero/02-project-workflows/workflow.html#13).

5. Use RStudio/GitHub system for homework submission
...
class GitHub organization. You will open *GitHub issues* when you need to ask
homework questions. 
