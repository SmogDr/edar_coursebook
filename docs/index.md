...
### Install the EDAR interactive tutorials

This course includes interactive R tutorials that allow you to practice R programming directly within RStudio. The tutorials are distributed in an R package called `edarlearn`.

You only need to install `edarlearn` once, although you may need to reinstall it later if the course tutorials are updated.
...
Then install the course-tested version of the EDAR tutorial package directly from GitHub:
...
If the **Tutorial** tab is not visible, you can also launch the tutorials from the Console:
...
If you are asked to update the tutorials later in the semester, you will be given a new installation command.
...
exercise
- Interactive R tutorials that reinforce foundational programming and data-analysis skills 
