...
### Correlation $\neq$ causation
<div class="rmdnote">
<p>Causation (or cause and effect) is influence by which one event, process or state, a cause, that contributes to the production of another event, process or state, an effect, where the cause is partly responsible for the effect, and the effect is partly dependent on the cause. - <em><sup>Wikipedia</sup></em></p>
</div>
...
> Did you know that being a smoker is correlated with having a lighter in your pocket?  Furthermore, it can be shown that having a lighter in your pocket is correlated with heart disease and lung cancer.  Does that mean that keeping a lighter in your pocket is a cause of lung cancer?
