...
##   ..$ manufacturer: chr [1:7] "toyota" "audi" "volkswagen" "volkswagen" ...
##   ..$ model       : chr [1:7] "4runner 4wd" "a4 quattro" "gti" "jetta" ...
##   ..$ displ       : num [1:7] 4 3.1 2 2 2.5 2.4 5.4
##   ..$ year        : int [1:7] 2008 2008 1999 1999 2008 1999 1999
##   ..$ cyl         : int [1:7] 6 6 4 4 4 4 8
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(s6)" "auto(l4)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "4" "f" "f" ...
##   ..$ cty         : int [1:7] 16 17 19 19 23 18 11
##   ..$ hwy         : int [1:7] 20 25 26 26 32 24 17
##   ..$ fl          : chr [1:7] "r" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "compact" "compact" "compact" ...
```
