...
##   ..$ manufacturer: chr [1:7] "volkswagen" "dodge" "volkswagen" "pontiac" ...
##   ..$ model       : chr [1:7] "passat" "durango 4wd" "new beetle" "grand prix" ...
##   ..$ displ       : num [1:7] 2.8 4.7 2.5 5.3 2.2 2.5 2.5
##   ..$ year        : int [1:7] 1999 2008 2008 2008 1999 1999 2008
##   ..$ cyl         : int [1:7] 6 8 5 8 4 4 4
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(l5)" "manual(m5)" "auto(s4)" ...
##   ..$ drv         : chr [1:7] "f" "4" "f" "f" ...
##   ..$ cty         : int [1:7] 16 13 20 16 19 18 23
##   ..$ hwy         : int [1:7] 26 17 28 25 26 24 32
##   ..$ fl          : chr [1:7] "p" "r" "r" "p" ...
##   ..$ class       : chr [1:7] "midsize" "suv" "subcompact" "midsize" ...
```
