...
##   ..$ manufacturer: chr [1:7] "chevrolet" "dodge" "ford" "volkswagen" ...
##   ..$ model       : chr [1:7] "c1500 suburban 2wd" "caravan 2wd" "mustang" "jetta" ...
##   ..$ displ       : num [1:7] 5.3 4 4.6 2 1.8 3.5 2.5
##   ..$ year        : int [1:7] 2008 2008 1999 1999 1999 2008 1999
##   ..$ cyl         : int [1:7] 8 6 8 4 4 6 4
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(l6)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "r" "f" "r" "f" ...
##   ..$ cty         : int [1:7] 11 16 15 19 21 18 18
##   ..$ hwy         : int [1:7] 15 23 22 26 29 29 25
##   ..$ fl          : chr [1:7] "e" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "minivan" "subcompact" "compact" ...
```
