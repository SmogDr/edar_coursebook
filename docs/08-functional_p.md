...
##   ..$ manufacturer: chr [1:7] "ford" "nissan" "hyundai" "toyota" ...
##   ..$ model       : chr [1:7] "mustang" "maxima" "sonata" "corolla" ...
##   ..$ displ       : num [1:7] 3.8 3.5 2.4 1.8 4.6 4 5.2
##   ..$ year        : int [1:7] 1999 2008 2008 1999 2008 1999 1999
##   ..$ cyl         : int [1:7] 6 6 4 4 8 6 8
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(av)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "r" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 18 19 21 24 13 15 11
##   ..$ hwy         : int [1:7] 25 25 31 33 17 19 16
##   ..$ fl          : chr [1:7] "r" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "subcompact" "midsize" "midsize" "compact" ...
```
