...
##   ..$ manufacturer: chr [1:7] "nissan" "subaru" "audi" "nissan" ...
##   ..$ model       : chr [1:7] "altima" "impreza awd" "a4" "pathfinder 4wd" ...
##   ..$ displ       : num [1:7] 3.5 2.2 2 3.3 2.2 2 2.2
##   ..$ year        : int [1:7] 2008 1999 2008 1999 1999 1999 1999
##   ..$ cyl         : int [1:7] 6 4 4 6 4 4 4
##   ..$ trans       : chr [1:7] "auto(av)" "auto(l4)" "manual(m6)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "f" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 19 21 20 14 19 21 21
##   ..$ hwy         : int [1:7] 26 26 31 17 26 29 29
##   ..$ fl          : chr [1:7] "p" "r" "p" "r" ...
##   ..$ class       : chr [1:7] "midsize" "subcompact" "compact" "suv" ...
```
