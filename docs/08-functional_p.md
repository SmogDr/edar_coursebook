...
##   ..$ manufacturer: chr [1:7] "chevrolet" "volkswagen" "volkswagen" "ford" ...
##   ..$ model       : chr [1:7] "corvette" "new beetle" "gti" "explorer 4wd" ...
##   ..$ displ       : num [1:7] 7 2.5 2 4 2.5 2.7 2
##   ..$ year        : int [1:7] 2008 2008 2008 1999 2008 2008 1999
##   ..$ cyl         : int [1:7] 8 5 4 6 5 6 4
##   ..$ trans       : chr [1:7] "manual(m6)" "manual(m5)" "auto(s6)" "auto(l5)" ...
##   ..$ drv         : chr [1:7] "r" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 15 20 22 14 20 16 21
##   ..$ hwy         : int [1:7] 24 28 29 17 29 24 29
##   ..$ fl          : chr [1:7] "p" "r" "p" "r" ...
##   ..$ class       : chr [1:7] "2seater" "subcompact" "compact" "suv" ...
```
