...
##   ..$ manufacturer: chr [1:7] "audi" "dodge" "chevrolet" "dodge" ...
##   ..$ model       : chr [1:7] "a4" "dakota pickup 4wd" "malibu" "dakota pickup 4wd" ...
##   ..$ displ       : num [1:7] 1.8 3.9 2.4 4.7 1.8 3.3 5.3
##   ..$ year        : int [1:7] 1999 1999 1999 2008 1999 2008 2008
##   ..$ cyl         : int [1:7] 4 6 4 8 4 6 8
##   ..$ trans       : chr [1:7] "manual(m5)" "manual(m5)" "auto(l4)" "auto(l5)" ...
##   ..$ drv         : chr [1:7] "f" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 21 14 19 14 24 11 11
##   ..$ hwy         : int [1:7] 29 17 27 19 30 17 14
##   ..$ fl          : chr [1:7] "p" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "compact" "pickup" "midsize" "pickup" ...
```
