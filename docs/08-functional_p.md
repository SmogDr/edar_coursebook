...
##   ..$ manufacturer: chr [1:7] "toyota" "toyota" "subaru" "audi" ...
##   ..$ model       : chr [1:7] "land cruiser wagon 4wd" "camry" "impreza awd" "a4 quattro" ...
##   ..$ displ       : num [1:7] 5.7 3.5 2.5 1.8 4.2 2.5 2.4
##   ..$ year        : int [1:7] 2008 2008 1999 1999 2008 1999 1999
##   ..$ cyl         : int [1:7] 8 6 4 4 8 4 4
##   ..$ trans       : chr [1:7] "auto(s6)" "auto(s6)" "auto(l4)" "auto(l5)" ...
##   ..$ drv         : chr [1:7] "4" "f" "4" "4" ...
##   ..$ cty         : int [1:7] 13 19 19 16 12 18 19
##   ..$ hwy         : int [1:7] 18 28 26 25 18 25 27
##   ..$ fl          : chr [1:7] "r" "r" "r" "p" ...
##   ..$ class       : chr [1:7] "suv" "midsize" "subcompact" "compact" ...
```
