...
##   ..$ manufacturer: chr [1:7] "toyota" "dodge" "toyota" "dodge" ...
##   ..$ model       : chr [1:7] "4runner 4wd" "durango 4wd" "camry solara" "durango 4wd" ...
##   ..$ displ       : num [1:7] 4 4.7 3 4.7 3.9 1.6 2
##   ..$ year        : int [1:7] 2008 2008 1999 2008 1999 1999 2008
##   ..$ cyl         : int [1:7] 6 8 6 8 6 4 4
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(l5)" "manual(m5)" "auto(l5)" ...
##   ..$ drv         : chr [1:7] "4" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 16 9 18 13 13 24 19
##   ..$ hwy         : int [1:7] 20 12 26 17 17 32 28
##   ..$ fl          : chr [1:7] "r" "e" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "suv" "compact" "suv" ...
```
