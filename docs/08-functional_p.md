...
##   ..$ manufacturer: chr [1:7] "jeep" "dodge" "honda" "toyota" ...
##   ..$ model       : chr [1:7] "grand cherokee 4wd" "ram 1500 pickup 4wd" "civic" "land cruiser wagon 4wd" ...
##   ..$ displ       : num [1:7] 4.7 4.7 1.6 5.7 2.8 1.8 5.2
##   ..$ year        : int [1:7] 2008 2008 1999 2008 1999 1999 1999
##   ..$ cyl         : int [1:7] 8 8 4 8 6 4 8
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(l5)" "auto(l4)" "auto(s6)" ...
##   ..$ drv         : chr [1:7] "4" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 14 9 24 13 16 18 11
##   ..$ hwy         : int [1:7] 19 12 32 18 26 26 16
##   ..$ fl          : chr [1:7] "r" "e" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "pickup" "subcompact" "suv" ...
```
