...
##   ..$ manufacturer: chr [1:7] "toyota" "volkswagen" "toyota" "subaru" ...
##   ..$ model       : chr [1:7] "toyota tacoma 4wd" "jetta" "camry" "forester awd" ...
##   ..$ displ       : num [1:7] 4 2 3 2.5 5.3 5.4 3.3
##   ..$ year        : int [1:7] 2008 2008 1999 1999 2008 1999 1999
##   ..$ cyl         : int [1:7] 6 4 6 4 8 8 6
##   ..$ trans       : chr [1:7] "auto(l5)" "manual(m6)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 16 21 18 18 14 11 16
##   ..$ hwy         : int [1:7] 20 29 26 24 20 15 22
##   ..$ fl          : chr [1:7] "r" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "pickup" "compact" "midsize" "suv" ...
```
