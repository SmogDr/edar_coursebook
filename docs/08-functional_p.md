...
##   ..$ manufacturer: chr [1:7] "land rover" "mercury" "dodge" "audi" ...
##   ..$ model       : chr [1:7] "range rover" "mountaineer 4wd" "caravan 2wd" "a4 quattro" ...
##   ..$ displ       : num [1:7] 4 4.6 4 2.8 1.6 4.6 4.6
##   ..$ year        : int [1:7] 1999 2008 2008 1999 1999 1999 1999
##   ..$ cyl         : int [1:7] 8 8 6 6 4 8 8
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(l6)" "auto(l6)" "manual(m5)" ...
##   ..$ drv         : chr [1:7] "4" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 11 13 16 17 24 11 11
##   ..$ hwy         : int [1:7] 15 19 23 25 32 15 17
##   ..$ fl          : chr [1:7] "p" "r" "r" "p" ...
##   ..$ class       : chr [1:7] "suv" "suv" "minivan" "compact" ...
```
