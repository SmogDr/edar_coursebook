...
##   ..$ manufacturer: chr [1:7] "honda" "nissan" "dodge" "hyundai" ...
##   ..$ model       : chr [1:7] "civic" "altima" "caravan 2wd" "tiburon" ...
##   ..$ displ       : num [1:7] 1.6 3.5 2.4 2.7 5.7 4 3.3
##   ..$ year        : int [1:7] 1999 2008 1999 2008 2008 2008 1999
##   ..$ cyl         : int [1:7] 4 6 4 6 8 6 6
##   ..$ trans       : chr [1:7] "manual(m5)" "manual(m6)" "auto(l3)" "manual(m6)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 23 19 18 16 13 14 16
##   ..$ hwy         : int [1:7] 29 27 24 24 18 20 22
##   ..$ fl          : chr [1:7] "p" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "subcompact" "midsize" "minivan" "subcompact" ...
```
