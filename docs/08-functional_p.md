...
##   ..$ manufacturer: chr [1:7] "volkswagen" "toyota" "audi" "dodge" ...
##   ..$ model       : chr [1:7] "jetta" "land cruiser wagon 4wd" "a6 quattro" "durango 4wd" ...
##   ..$ displ       : num [1:7] 2 4.7 4.2 5.7 3.8 1.8 4.7
##   ..$ year        : int [1:7] 2008 1999 2008 2008 1999 1999 2008
##   ..$ cyl         : int [1:7] 4 8 8 8 6 4 8
##   ..$ trans       : chr [1:7] "auto(s6)" "auto(l4)" "auto(s6)" "auto(l5)" ...
##   ..$ drv         : chr [1:7] "f" "4" "4" "4" ...
##   ..$ cty         : int [1:7] 22 11 16 13 16 26 9
##   ..$ hwy         : int [1:7] 29 15 23 18 26 35 12
##   ..$ fl          : chr [1:7] "p" "r" "p" "r" ...
##   ..$ class       : chr [1:7] "compact" "suv" "midsize" "suv" ...
```
