...
##   ..$ manufacturer: chr [1:7] "ford" "toyota" "mercury" "audi" ...
##   ..$ model       : chr [1:7] "mustang" "camry solara" "mountaineer 4wd" "a4" ...
##   ..$ displ       : num [1:7] 4 2.2 5 1.8 5.2 2.7 2.5
##   ..$ year        : int [1:7] 2008 1999 1999 1999 1999 1999 1999
##   ..$ cyl         : int [1:7] 6 4 8 4 8 4 4
##   ..$ trans       : chr [1:7] "auto(l5)" "manual(m5)" "auto(l4)" "auto(l5)" ...
##   ..$ drv         : chr [1:7] "r" "f" "4" "f" ...
##   ..$ cty         : int [1:7] 16 21 13 18 11 15 18
##   ..$ hwy         : int [1:7] 24 29 17 29 15 20 24
##   ..$ fl          : chr [1:7] "r" "r" "r" "p" ...
##   ..$ class       : chr [1:7] "subcompact" "compact" "suv" "compact" ...
```
