...
##   ..$ manufacturer: chr [1:7] "nissan" "honda" "dodge" "volkswagen" ...
##   ..$ model       : chr [1:7] "maxima" "civic" "caravan 2wd" "new beetle" ...
##   ..$ displ       : num [1:7] 3 1.6 3 2.5 4.2 3.8 4.7
##   ..$ year        : int [1:7] 1999 1999 1999 2008 2008 1999 2008
##   ..$ cyl         : int [1:7] 6 4 6 5 8 6 8
##   ..$ trans       : chr [1:7] "manual(m5)" "manual(m5)" "auto(l4)" "auto(s6)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 19 25 17 20 12 15 13
##   ..$ hwy         : int [1:7] 25 32 24 29 18 21 17
##   ..$ fl          : chr [1:7] "r" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "midsize" "subcompact" "minivan" "subcompact" ...
```
