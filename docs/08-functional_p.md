...
##   ..$ manufacturer: chr [1:7] "toyota" "audi" "jeep" "hyundai" ...
##   ..$ model       : chr [1:7] "land cruiser wagon 4wd" "a4" "grand cherokee 4wd" "tiburon" ...
##   ..$ displ       : num [1:7] 4.7 2 3.7 2 6.1 4.7 3.7
##   ..$ year        : int [1:7] 1999 2008 2008 1999 2008 2008 2008
##   ..$ cyl         : int [1:7] 8 4 6 4 8 8 6
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(av)" "auto(l5)" "manual(m5)" ...
##   ..$ drv         : chr [1:7] "4" "f" "4" "f" ...
##   ..$ cty         : int [1:7] 11 21 15 19 11 13 15
##   ..$ hwy         : int [1:7] 15 30 19 29 14 17 19
##   ..$ fl          : chr [1:7] "r" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "compact" "suv" "subcompact" ...
```
