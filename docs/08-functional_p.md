...
##   ..$ manufacturer: chr [1:7] "subaru" "volkswagen" "toyota" "toyota" ...
##   ..$ model       : chr [1:7] "impreza awd" "new beetle" "camry solara" "land cruiser wagon 4wd" ...
##   ..$ displ       : num [1:7] 2.5 2 2.4 5.7 5.3 5.4 2.7
##   ..$ year        : int [1:7] 2008 1999 2008 2008 2008 1999 2008
##   ..$ cyl         : int [1:7] 4 4 4 8 8 8 4
##   ..$ trans       : chr [1:7] "manual(m5)" "manual(m5)" "auto(s5)" "auto(s6)" ...
##   ..$ drv         : chr [1:7] "4" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 19 21 22 13 16 11 17
##   ..$ hwy         : int [1:7] 25 29 31 18 25 16 22
##   ..$ fl          : chr [1:7] "p" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "compact" "subcompact" "compact" "suv" ...
```
