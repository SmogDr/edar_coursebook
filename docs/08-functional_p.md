...
##   ..$ manufacturer: chr [1:7] "ford" "volkswagen" "toyota" "dodge" ...
##   ..$ model       : chr [1:7] "expedition 2wd" "jetta" "4runner 4wd" "caravan 2wd" ...
##   ..$ displ       : num [1:7] 4.6 2.5 4.7 3.3 5.3 2 5.7
##   ..$ year        : int [1:7] 1999 2008 2008 1999 2008 2008 2008
##   ..$ cyl         : int [1:7] 8 5 8 6 8 4 8
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(s6)" "auto(l5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "r" "f" "4" "f" ...
##   ..$ cty         : int [1:7] 11 21 14 16 16 22 13
##   ..$ hwy         : int [1:7] 17 29 17 22 25 29 17
##   ..$ fl          : chr [1:7] "r" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "compact" "suv" "minivan" ...
```
