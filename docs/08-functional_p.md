...
##   ..$ manufacturer: chr [1:7] "volkswagen" "volkswagen" "ford" "chevrolet" ...
##   ..$ model       : chr [1:7] "passat" "passat" "mustang" "c1500 suburban 2wd" ...
##   ..$ displ       : num [1:7] 2.8 2 4 5.7 2.5 1.8 3.1
##   ..$ year        : int [1:7] 1999 2008 2008 1999 1999 1999 2008
##   ..$ cyl         : int [1:7] 6 4 6 8 6 4 6
##   ..$ trans       : chr [1:7] "manual(m5)" "manual(m6)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "f" "f" "r" "r" ...
##   ..$ cty         : int [1:7] 18 21 17 13 18 18 15
##   ..$ hwy         : int [1:7] 26 29 26 17 26 26 25
##   ..$ fl          : chr [1:7] "p" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "midsize" "midsize" "subcompact" "suv" ...
```
