...
##   ..$ manufacturer: chr [1:7] "subaru" "volkswagen" "toyota" "dodge" ...
##   ..$ model       : chr [1:7] "impreza awd" "passat" "camry" "ram 1500 pickup 4wd" ...
##   ..$ displ       : num [1:7] 2.5 2.8 2.2 5.9 2.8 5.7 3.1
##   ..$ year        : int [1:7] 2008 1999 1999 1999 1999 2008 2008
##   ..$ cyl         : int [1:7] 4 6 4 8 6 8 6
##   ..$ trans       : chr [1:7] "auto(s4)" "manual(m5)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 20 18 21 11 18 13 15
##   ..$ hwy         : int [1:7] 25 26 29 15 26 17 25
##   ..$ fl          : chr [1:7] "p" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "compact" "midsize" "midsize" "pickup" ...
```
