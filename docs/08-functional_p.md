...
##   ..$ manufacturer: chr [1:7] "audi" "volkswagen" "dodge" "volkswagen" ...
##   ..$ model       : chr [1:7] "a4" "passat" "caravan 2wd" "gti" ...
##   ..$ displ       : num [1:7] 2.8 1.8 3.3 2 2 2.5 4.7
##   ..$ year        : int [1:7] 1999 1999 2008 1999 2008 2008 2008
##   ..$ cyl         : int [1:7] 6 4 6 4 4 4 8
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(l5)" "auto(l4)" "manual(m5)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 16 18 17 21 21 19 14
##   ..$ hwy         : int [1:7] 26 29 24 29 29 25 19
##   ..$ fl          : chr [1:7] "p" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "compact" "midsize" "minivan" "compact" ...
```
