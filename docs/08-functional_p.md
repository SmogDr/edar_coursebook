...
##   ..$ manufacturer: chr [1:7] "lincoln" "nissan" "chevrolet" "dodge" ...
##   ..$ model       : chr [1:7] "navigator 2wd" "maxima" "malibu" "ram 1500 pickup 4wd" ...
##   ..$ displ       : num [1:7] 5.4 3.5 3.5 4.7 2.2 3.1 2.5
##   ..$ year        : int [1:7] 1999 2008 2008 2008 1999 1999 2008
##   ..$ cyl         : int [1:7] 8 6 6 8 4 6 4
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(av)" "auto(l4)" "manual(m6)" ...
##   ..$ drv         : chr [1:7] "r" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 11 19 18 12 21 18 18
##   ..$ hwy         : int [1:7] 16 25 29 16 29 26 23
##   ..$ fl          : chr [1:7] "p" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "midsize" "midsize" "pickup" ...
```
