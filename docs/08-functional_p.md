...
##   ..$ manufacturer: chr [1:7] "honda" "chevrolet" "dodge" "toyota" ...
##   ..$ model       : chr [1:7] "civic" "malibu" "caravan 2wd" "land cruiser wagon 4wd" ...
##   ..$ displ       : num [1:7] 1.8 3.5 3.3 5.7 2 5.4 2.4
##   ..$ year        : int [1:7] 2008 2008 1999 2008 2008 2008 2008
##   ..$ cyl         : int [1:7] 4 6 6 8 4 8 4
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(l4)" "auto(l4)" "auto(s6)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 24 18 16 13 22 13 21
##   ..$ hwy         : int [1:7] 36 29 22 18 29 17 30
##   ..$ fl          : chr [1:7] "c" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "subcompact" "midsize" "minivan" "suv" ...
```
