...
##   ..$ manufacturer: chr [1:7] "jeep" "toyota" "nissan" "toyota" ...
##   ..$ model       : chr [1:7] "grand cherokee 4wd" "toyota tacoma 4wd" "pathfinder 4wd" "corolla" ...
##   ..$ displ       : num [1:7] 4.7 2.7 5.6 1.8 2.5 5.2 2.7
##   ..$ year        : int [1:7] 2008 2008 2008 1999 1999 1999 1999
##   ..$ cyl         : int [1:7] 8 4 8 4 4 8 4
##   ..$ trans       : chr [1:7] "auto(l5)" "manual(m5)" "auto(s5)" "auto(l3)" ...
##   ..$ drv         : chr [1:7] "4" "4" "4" "f" ...
##   ..$ cty         : int [1:7] 9 17 12 24 19 11 16
##   ..$ hwy         : int [1:7] 12 22 18 30 26 15 20
##   ..$ fl          : chr [1:7] "e" "r" "p" "r" ...
##   ..$ class       : chr [1:7] "suv" "pickup" "suv" "compact" ...
```
