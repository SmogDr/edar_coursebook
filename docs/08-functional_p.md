...
##   ..$ manufacturer: chr [1:7] "dodge" "jeep" "toyota" "chevrolet" ...
##   ..$ model       : chr [1:7] "caravan 2wd" "grand cherokee 4wd" "camry solara" "k1500 tahoe 4wd" ...
##   ..$ displ       : num [1:7] 3.8 4.7 2.2 6.5 3.1 2.7 4.7
##   ..$ year        : int [1:7] 1999 1999 1999 1999 2008 1999 2008
##   ..$ cyl         : int [1:7] 6 8 4 8 6 4 8
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(l4)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "f" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 15 14 21 14 17 15 13
##   ..$ hwy         : int [1:7] 22 17 29 17 25 20 17
##   ..$ fl          : chr [1:7] "r" "r" "r" "d" ...
##   ..$ class       : chr [1:7] "minivan" "suv" "compact" "suv" ...
```
