...
##   ..$ manufacturer: chr [1:7] "dodge" "dodge" "hyundai" "subaru" ...
##   ..$ model       : chr [1:7] "ram 1500 pickup 4wd" "ram 1500 pickup 4wd" "sonata" "forester awd" ...
##   ..$ displ       : num [1:7] 5.2 4.7 2.5 2.5 1.6 5.4 3.1
##   ..$ year        : int [1:7] 1999 2008 1999 2008 1999 2008 1999
##   ..$ cyl         : int [1:7] 8 8 6 4 4 8 6
##   ..$ trans       : chr [1:7] "manual(m5)" "manual(m6)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 11 12 18 18 24 12 18
##   ..$ hwy         : int [1:7] 16 16 26 23 32 18 26
##   ..$ fl          : chr [1:7] "r" "r" "r" "p" ...
##   ..$ class       : chr [1:7] "pickup" "pickup" "midsize" "suv" ...
```
