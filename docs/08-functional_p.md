...
##   ..$ manufacturer: chr [1:7] "toyota" "chevrolet" "volkswagen" "hyundai" ...
##   ..$ model       : chr [1:7] "4runner 4wd" "corvette" "jetta" "sonata" ...
##   ..$ displ       : num [1:7] 3.4 6.2 2 2.5 2.4 1.8 2.5
##   ..$ year        : int [1:7] 1999 2008 2008 1999 2008 2008 1999
##   ..$ cyl         : int [1:7] 6 8 4 6 4 4 6
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(s6)" "auto(s6)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "r" "f" "f" ...
##   ..$ cty         : int [1:7] 15 15 22 18 21 25 18
##   ..$ hwy         : int [1:7] 19 25 29 26 31 36 26
##   ..$ fl          : chr [1:7] "r" "p" "p" "r" ...
##   ..$ class       : chr [1:7] "suv" "2seater" "compact" "midsize" ...
```
