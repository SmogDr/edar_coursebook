...
##   ..$ manufacturer: chr [1:7] "pontiac" "subaru" "dodge" "dodge" ...
##   ..$ model       : chr [1:7] "grand prix" "impreza awd" "caravan 2wd" "dakota pickup 4wd" ...
##   ..$ displ       : num [1:7] 3.8 2.5 3.3 3.9 1.6 3.9 2.5
##   ..$ year        : int [1:7] 1999 2008 1999 1999 1999 1999 2008
##   ..$ cyl         : int [1:7] 6 4 6 6 4 6 4
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(s4)" "auto(l4)" "manual(m5)" ...
##   ..$ drv         : chr [1:7] "f" "4" "f" "4" ...
##   ..$ cty         : int [1:7] 17 20 16 14 24 13 23
##   ..$ hwy         : int [1:7] 27 25 22 17 32 17 32
##   ..$ fl          : chr [1:7] "r" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "midsize" "compact" "minivan" "pickup" ...
```
