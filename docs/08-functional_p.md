...
##   ..$ manufacturer: chr [1:7] "dodge" "nissan" "dodge" "jeep" ...
##   ..$ model       : chr [1:7] "ram 1500 pickup 4wd" "altima" "caravan 2wd" "grand cherokee 4wd" ...
##   ..$ displ       : num [1:7] 4.7 3.5 3.8 4.7 4 2.7 5.4
##   ..$ year        : int [1:7] 2008 2008 1999 2008 2008 1999 1999
##   ..$ cyl         : int [1:7] 8 6 6 8 6 4 8
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(av)" "auto(l4)" "auto(l5)" ...
##   ..$ drv         : chr [1:7] "4" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 9 19 15 14 13 15 11
##   ..$ hwy         : int [1:7] 12 26 21 19 19 20 15
##   ..$ fl          : chr [1:7] "e" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "pickup" "midsize" "minivan" "suv" ...
```
