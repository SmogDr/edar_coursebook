...
##   ..$ manufacturer: chr [1:7] "hyundai" "audi" "volkswagen" "audi" ...
##   ..$ model       : chr [1:7] "tiburon" "a4 quattro" "new beetle" "a4" ...
##   ..$ displ       : num [1:7] 2.7 3.1 1.9 2.8 1.9 4.7 5.2
##   ..$ year        : int [1:7] 2008 2008 1999 1999 1999 2008 1999
##   ..$ cyl         : int [1:7] 6 6 4 6 4 8 8
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(s6)" "manual(m5)" "manual(m5)" ...
##   ..$ drv         : chr [1:7] "f" "4" "f" "f" ...
##   ..$ cty         : int [1:7] 17 17 35 18 33 13 11
##   ..$ hwy         : int [1:7] 24 25 44 26 44 17 15
##   ..$ fl          : chr [1:7] "r" "p" "d" "p" ...
##   ..$ class       : chr [1:7] "subcompact" "compact" "subcompact" "compact" ...
```
