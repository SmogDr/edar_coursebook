...
##   ..$ manufacturer: chr [1:7] "audi" "hyundai" "toyota" "dodge" ...
##   ..$ model       : chr [1:7] "a4 quattro" "sonata" "camry" "caravan 2wd" ...
##   ..$ displ       : num [1:7] 3.1 2.4 2.2 3 5.2 2.5 2.8
##   ..$ year        : int [1:7] 2008 1999 1999 1999 1999 2008 1999
##   ..$ cyl         : int [1:7] 6 4 4 6 8 4 6
##   ..$ trans       : chr [1:7] "auto(s6)" "auto(l4)" "auto(l4)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 17 18 21 17 11 18 18
##   ..$ hwy         : int [1:7] 25 26 27 24 15 23 26
##   ..$ fl          : chr [1:7] "p" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "compact" "midsize" "midsize" "minivan" ...
```
