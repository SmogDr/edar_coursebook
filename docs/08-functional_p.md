...
##   ..$ manufacturer: chr [1:7] "chevrolet" "volkswagen" "toyota" "jeep" ...
##   ..$ model       : chr [1:7] "malibu" "passat" "camry" "grand cherokee 4wd" ...
##   ..$ displ       : num [1:7] 3.5 1.8 3 4.7 6 4.7 3.6
##   ..$ year        : int [1:7] 2008 1999 1999 1999 2008 2008 2008
##   ..$ cyl         : int [1:7] 6 4 6 8 8 8 6
##   ..$ trans       : chr [1:7] "auto(l4)" "manual(m5)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 18 21 18 14 12 13 17
##   ..$ hwy         : int [1:7] 29 29 26 17 17 17 26
##   ..$ fl          : chr [1:7] "r" "p" "r" "r" ...
##   ..$ class       : chr [1:7] "midsize" "midsize" "midsize" "suv" ...
```
