...
##   ..$ manufacturer: chr [1:7] "hyundai" "hyundai" "volkswagen" "volkswagen" ...
##   ..$ model       : chr [1:7] "sonata" "tiburon" "gti" "jetta" ...
##   ..$ displ       : num [1:7] 2.4 2 2 2.5 4.6 2.5 2.2
##   ..$ year        : int [1:7] 2008 1999 1999 2008 1999 1999 1999
##   ..$ cyl         : int [1:7] 4 4 4 5 8 4 4
##   ..$ trans       : chr [1:7] "auto(l4)" "manual(m5)" "manual(m5)" "auto(s6)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 21 19 21 21 13 19 21
##   ..$ hwy         : int [1:7] 30 29 29 29 16 26 29
##   ..$ fl          : chr [1:7] "r" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "midsize" "subcompact" "compact" "compact" ...
```
