...
##   ..$ manufacturer: chr [1:7] "audi" "ford" "toyota" "volkswagen" ...
##   ..$ model       : chr [1:7] "a4" "expedition 2wd" "camry" "gti" ...
##   ..$ displ       : num [1:7] 2 5.4 2.4 2 2.7 2.7 5.4
##   ..$ year        : int [1:7] 2008 2008 2008 2008 1999 1999 1999
##   ..$ cyl         : int [1:7] 4 8 4 4 4 4 8
##   ..$ trans       : chr [1:7] "auto(av)" "auto(l6)" "manual(m5)" "manual(m6)" ...
##   ..$ drv         : chr [1:7] "f" "r" "f" "f" ...
##   ..$ cty         : int [1:7] 21 12 21 21 16 15 11
##   ..$ hwy         : int [1:7] 30 18 31 29 20 20 15
##   ..$ fl          : chr [1:7] "p" "r" "r" "p" ...
##   ..$ class       : chr [1:7] "compact" "suv" "midsize" "compact" ...
```
