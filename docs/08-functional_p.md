...
##   ..$ manufacturer: chr [1:7] "dodge" "chevrolet" "audi" "hyundai" ...
##   ..$ model       : chr [1:7] "caravan 2wd" "c1500 suburban 2wd" "a4 quattro" "tiburon" ...
##   ..$ displ       : num [1:7] 3.8 5.3 3.1 2.7 4.6 4.2 5.3
##   ..$ year        : int [1:7] 1999 2008 2008 2008 2008 2008 2008
##   ..$ cyl         : int [1:7] 6 8 6 6 8 8 8
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(l4)" "auto(s6)" "manual(m6)" ...
##   ..$ drv         : chr [1:7] "f" "r" "4" "f" ...
##   ..$ cty         : int [1:7] 15 14 17 16 13 16 11
##   ..$ hwy         : int [1:7] 21 20 25 24 19 23 15
##   ..$ fl          : chr [1:7] "r" "r" "p" "r" ...
##   ..$ class       : chr [1:7] "minivan" "suv" "compact" "subcompact" ...
```
