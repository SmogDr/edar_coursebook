...
##   ..$ manufacturer: chr [1:7] "audi" "hyundai" "subaru" "volkswagen" ...
##   ..$ model       : chr [1:7] "a4 quattro" "sonata" "impreza awd" "jetta" ...
##   ..$ displ       : num [1:7] 3.1 2.5 2.5 2.8 4.7 6 3.3
##   ..$ year        : int [1:7] 2008 1999 1999 1999 2008 2008 1999
##   ..$ cyl         : int [1:7] 6 6 4 6 8 8 6
##   ..$ trans       : chr [1:7] "manual(m6)" "auto(l4)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "f" "4" "f" ...
##   ..$ cty         : int [1:7] 15 18 19 16 9 12 15
##   ..$ hwy         : int [1:7] 25 26 26 23 12 17 17
##   ..$ fl          : chr [1:7] "p" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "compact" "midsize" "subcompact" "compact" ...
```
