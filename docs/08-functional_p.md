...
##   ..$ manufacturer: chr [1:7] "chevrolet" "volkswagen" "honda" "volkswagen" ...
##   ..$ model       : chr [1:7] "malibu" "jetta" "civic" "gti" ...
##   ..$ displ       : num [1:7] 3.6 2.8 1.6 2 4.7 1.8 3
##   ..$ year        : int [1:7] 2008 1999 1999 2008 2008 2008 1999
##   ..$ cyl         : int [1:7] 6 6 4 4 8 4 6
##   ..$ trans       : chr [1:7] "auto(s6)" "auto(l4)" "manual(m5)" "auto(s6)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 17 16 23 22 9 26 18
##   ..$ hwy         : int [1:7] 26 23 29 29 12 35 26
##   ..$ fl          : chr [1:7] "r" "r" "p" "p" ...
##   ..$ class       : chr [1:7] "midsize" "compact" "subcompact" "compact" ...
```
