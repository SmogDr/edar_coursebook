...
##   ..$ manufacturer: chr [1:7] "jeep" "hyundai" "audi" "nissan" ...
##   ..$ model       : chr [1:7] "grand cherokee 4wd" "sonata" "a4" "altima" ...
##   ..$ displ       : num [1:7] 4.7 2.4 3.1 2.5 3.1 6.2 3.7
##   ..$ year        : int [1:7] 2008 1999 2008 2008 1999 2008 2008
##   ..$ cyl         : int [1:7] 8 4 6 4 6 8 6
##   ..$ trans       : chr [1:7] "auto(l5)" "auto(l4)" "auto(av)" "auto(av)" ...
##   ..$ drv         : chr [1:7] "4" "f" "f" "f" ...
##   ..$ cty         : int [1:7] 14 18 18 23 18 16 14
##   ..$ hwy         : int [1:7] 19 26 27 31 26 26 18
##   ..$ fl          : chr [1:7] "r" "r" "p" "r" ...
##   ..$ class       : chr [1:7] "suv" "midsize" "compact" "midsize" ...
```
