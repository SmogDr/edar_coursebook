...
##   ..$ manufacturer: chr [1:7] "toyota" "chevrolet" "dodge" "dodge" ...
##   ..$ model       : chr [1:7] "camry solara" "c1500 suburban 2wd" "dakota pickup 4wd" "caravan 2wd" ...
##   ..$ displ       : num [1:7] 2.2 5.3 5.2 3.8 2.2 4.2 5.3
##   ..$ year        : int [1:7] 1999 2008 1999 2008 1999 2008 2008
##   ..$ cyl         : int [1:7] 4 8 8 6 4 8 8
##   ..$ trans       : chr [1:7] "manual(m5)" "auto(l4)" "manual(m5)" "auto(l6)" ...
##   ..$ drv         : chr [1:7] "f" "r" "4" "f" ...
##   ..$ cty         : int [1:7] 21 11 11 16 19 16 14
##   ..$ hwy         : int [1:7] 29 15 17 23 26 23 20
##   ..$ fl          : chr [1:7] "r" "e" "r" "r" ...
##   ..$ class       : chr [1:7] "compact" "suv" "pickup" "minivan" ...
```
