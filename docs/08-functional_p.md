...
##   ..$ manufacturer: chr [1:7] "pontiac" "subaru" "volkswagen" "nissan" ...
##   ..$ model       : chr [1:7] "grand prix" "forester awd" "jetta" "altima" ...
##   ..$ displ       : num [1:7] 3.8 2.5 2 2.4 2.7 2 2.5
##   ..$ year        : int [1:7] 2008 1999 2008 1999 2008 2008 2008
##   ..$ cyl         : int [1:7] 6 4 4 4 6 4 4
##   ..$ trans       : chr [1:7] "auto(l4)" "manual(m5)" "auto(s6)" "manual(m5)" ...
##   ..$ drv         : chr [1:7] "f" "4" "f" "f" ...
##   ..$ cty         : int [1:7] 18 18 22 21 16 22 20
##   ..$ hwy         : int [1:7] 28 25 29 29 24 29 26
##   ..$ fl          : chr [1:7] "r" "r" "p" "r" ...
##   ..$ class       : chr [1:7] "midsize" "suv" "compact" "compact" ...
```
