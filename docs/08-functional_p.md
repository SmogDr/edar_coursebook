...
##   ..$ manufacturer: chr [1:7] "dodge" "toyota" "dodge" "chevrolet" ...
##   ..$ model       : chr [1:7] "durango 4wd" "corolla" "durango 4wd" "malibu" ...
##   ..$ displ       : num [1:7] 4.7 1.8 3.9 3.1 3.3 5.7 3
##   ..$ year        : int [1:7] 2008 1999 1999 1999 1999 1999 1999
##   ..$ cyl         : int [1:7] 8 4 6 6 6 8 6
##   ..$ trans       : chr [1:7] "auto(l5)" "manual(m5)" "auto(l4)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "f" "4" "f" ...
##   ..$ cty         : int [1:7] 13 26 13 18 16 11 17
##   ..$ hwy         : int [1:7] 17 35 17 26 22 15 24
##   ..$ fl          : chr [1:7] "r" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "suv" "compact" "suv" "midsize" ...
```
