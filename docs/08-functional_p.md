...
##   ..$ manufacturer: chr [1:7] "chevrolet" "hyundai" "volkswagen" "audi" ...
##   ..$ model       : chr [1:7] "malibu" "sonata" "jetta" "a4 quattro" ...
##   ..$ displ       : num [1:7] 3.1 3.3 2.8 2 7 2.5 2.5
##   ..$ year        : int [1:7] 1999 2008 1999 2008 2008 2008 1999
##   ..$ cyl         : int [1:7] 6 6 6 4 8 4 6
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(l5)" "manual(m5)" "manual(m6)" ...
##   ..$ drv         : chr [1:7] "f" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 18 19 17 20 15 19 18
##   ..$ hwy         : int [1:7] 26 28 24 28 24 25 26
##   ..$ fl          : chr [1:7] "r" "r" "r" "p" ...
##   ..$ class       : chr [1:7] "midsize" "midsize" "compact" "compact" ...
```
