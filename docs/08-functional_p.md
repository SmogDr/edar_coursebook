...
##   ..$ manufacturer: chr [1:7] "subaru" "pontiac" "hyundai" "ford" ...
##   ..$ model       : chr [1:7] "forester awd" "grand prix" "sonata" "f150 pickup 4wd" ...
##   ..$ displ       : num [1:7] 2.5 3.8 2.5 4.6 2.8 1.9 4.7
##   ..$ year        : int [1:7] 2008 2008 1999 2008 1999 1999 2008
##   ..$ cyl         : int [1:7] 4 6 6 8 6 4 8
##   ..$ trans       : chr [1:7] "auto(l4)" "auto(l4)" "manual(m5)" "auto(l4)" ...
##   ..$ drv         : chr [1:7] "4" "f" "f" "4" ...
##   ..$ cty         : int [1:7] 18 18 18 13 17 33 13
##   ..$ hwy         : int [1:7] 23 28 26 17 24 44 17
##   ..$ fl          : chr [1:7] "p" "r" "r" "r" ...
