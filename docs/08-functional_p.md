...
- `body()`, to see the function's code
  ...
  [on GitHub](https://github.com/wch/r-source). 
...
look [here](https://www.r-bloggers.com/environments-in-r/) for an introduction 
to environments and 
[here](https://adv-r.hadley.nz/environments.html) for a more detailed tutorial.
...
*[this citizen-science network](http://www.purpleair.com/map) and published*
*by our research group [here](https://doi.org/10.1016/j.atmosenv.2019.117067) in 2019.*
The "PA" in each filename stands for [Purple Air](www.purpleair.com).
