...
##   ..$ manufacturer: chr [1:7] "audi" "lincoln" "toyota" "volkswagen" ...
##   ..$ model       : chr [1:7] "a6 quattro" "navigator 2wd" "camry" "new beetle" ...
##   ..$ displ       : num [1:7] 4.2 5.4 2.4 2.5 3.7 4.7 1.8
##   ..$ year        : int [1:7] 2008 1999 2008 2008 2008 1999 1999
##   ..$ cyl         : int [1:7] 8 8 4 5 6 8 4
##   ..$ trans       : chr [1:7] "auto(s6)" "auto(l4)" "manual(m5)" "auto(s6)" ...
##   ..$ drv         : chr [1:7] "4" "r" "f" "f" ...
##   ..$ cty         : int [1:7] 16 11 21 20 15 11 21
##   ..$ hwy         : int [1:7] 23 17 31 29 19 15 29
##   ..$ fl          : chr [1:7] "p" "r" "r" "r" ...
##   ..$ class       : chr [1:7] "midsize" "suv" "midsize" "subcompact" ...
```
