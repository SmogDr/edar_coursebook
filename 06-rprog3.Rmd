...
string_table <- tibble(
  stringr_funcs = c("str_detect(x, pattern)", "str_match(x, pattern)", "str_subset(x, pattern)"),
  base_funcs = c("grepl(pattern, x)","regexec(pattern, x) + regmatches()", "grep(pattern, x, value = TRUE)")
)
